...
class Home extends React.Component {
    render() {
        ...
        return(
            <div style={{height: '100vh', width: '100vw', display: 'grid', gridTemplateRows: '70px 1fr'}}>
                ...
                <div style={{gridRow: '2/3', backgroundImage: 'url(https://wallpapers.com/images/hd/all-pokemon-pictures-03imn29v8gsd3lup.jpg)', backgroundPosition: 'center', backgroundSize: '100vw 100vh', backgroundRepeat: 'no-repeat'}}>
                </div>
            </div>
        )
    }
